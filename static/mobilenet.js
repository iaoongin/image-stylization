        ...
        return e.prototype.load = function () {
            return o(this, void 0, void 0, function () {
                ...
                return i(this, function (i) {
                    switch (i.label) {
                        case 0:
                            return this.modelUrl ? (e = this, [4, a.loadGraphModel(this.modelUrl)]) : [3, 2];
                        case 1:
                            return e.model = i.sent(), [3, 4];
                        case 2:
                            return o = l[this.version][this.alpha].url, t = this, [4, a.loadGraphModel(o, {
                                fromTFHub: !0
                            })];
                        case 3:
                            t.model = i.sent(), i.label = 4;
                        case 4:
                            return [4, (n = r.tidy(function () {
                                return s.model.predict(r.zeros([1, 224, 224, 3]))
                            })).data()];
                        case 5:
                            return i.sent(), n.dispose(), [2]
                    }
                })
            })
        }, e.prototype.infer = function (e, a) {
            var o = this;
            return void 0 === a && (a = !1), r.tidy(function () {
                e instanceof r.Tensor || (e = r.browser.fromPixels(e));
                var i = r.add(r.mul(r.cast(e, "float32"), o.normalizationConstant), o.inputMin),
                    t = i;
                                ...
                                return o(this, void 0, void 0, function () {
                                    ...
                                    return i(this, function (i) {
                                        switch (i.label) {
                                            ...
                                            case 1:
                                                for (n = i.sent(), o.dispose(), l = [], h = 0; h < n.length; h++) l.push({
                                                    value: n[h],
                                                    index: h
                                                });
                                                for (l.sort(function (e, a) {
                                                        return a.value - e.value
                                                    }), s = new Float32Array(a), c = new Int32Array(a), h = 0; h < a; h++) s[h] = l[h].value, c[h] = l[h].index;
                                                for (u = [], h = 0; h < c.length; h++) u.push({
                                                    className: t[c[h]],
                                                    probability: s[h]
                                                });
                                                return [2, u]
    ...
    e.load = function (e) {
        return void 0 === e && (e = {
            ...
            return i(this, function (i) {
                switch (i.label) {
                    case 0:
                        if (null == r) throw new Error("Cannot find TensorFlow.js. If you are using a <script> tag, please also include @tensorflow/tfjs on the page before using this model.");
                        if (t = e.version.toFixed(2), n = e.alpha ? e.alpha.toFixed(2) : "", c = -1, u = 1, null == e.modelUrl) {
                            if (!(t in l)) throw new Error("Invalid version of MobileNet. Valid versions are: " + Object.keys(l));
                            if (!(n in l[t])) throw new Error("MobileNet constructed with invalid alpha " + e.alpha + ". Valid multipliers for this version are: " + Object.keys(l[t]) + ".");
                            a = l[t][n].inputRange, c = a[0], u = a[1]
                        }
                        return null != e.inputRange && (o = e.inputRange, c = o[0], u = o[1]), [4, (h = new s(t, n, e.modelUrl, c, u)).load()];
                    case 1:
                        return i.sent(), [2, h]
                }
            })
